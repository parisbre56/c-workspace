...
>&2 echo -e "\n%I"
echo -e "\n%I"
temp=$(conduct_test $tests "$procs" "$kappas" "__Question1__" "" "" "" "$progress" "$total")
echo "t1=$temp"
...
>&2 echo -e "\n%II"
echo -e "\n%II"
temp=$(conduct_test $tests "$procs" "$kappas" "__Question2__" "" "" "" "$progress" "$total")
echo "t2=$temp"
let progress = progress + 1 
...
>&2 echo -e "\n%I Single proc"
echo -e "\n%I Single proc"
temp=$(conduct_test $tests "1" "$kappas" "__Question1__" "__SingleProc__" "" "" "$progress" "$total")
echo "ts=$temp"
let progress = progress + 1 
...
>&2 echo -e "\n%Extra I"
echo -e "\n%Extra I"
temp=$(conduct_test $tests "$procs" "$kappas" "__Question1__" "__QuestionExtra__" "" "" "$progress" "$total")
echo "te1=$temp"
let progress = progress + 1 
...
>&2 echo -e "\n%Extra I Single proc"
echo -e "\n%Extra I Single proc"
temp=$(conduct_test $tests "1" "$kappas" "__Question1__" "__SingleProc__" "__QuestionExtra__" "" "$progress" "$total")
echo "tes=$temp"
let progress = progress + 1 
...
>&2 echo -e "\n%BTest I"
echo -e "\n%BTest I"
temp=$(conduct_test $tests "$procs" "$kappas" "__Question1__" "USE_BROADCAST" "" "" "$progress" "$total")
echo "bt1=$temp"
let progress = progress + 1 

>&2 echo -e "\n%BTest II"
echo -e "\n%BTest II"
temp=$(conduct_test $tests "$procs" "$kappas" "__Question2__" "USE_BROADCAST" "" "" "$progress" "$total")
echo "bt2=$temp"
let progress = progress + 1 

>&2 echo -e "\n%BTest I Single proc"
echo -e "\n%BTest I Single proc"
temp=$(conduct_test $tests "1" "$kappas" "__Question1__" "__SingleProc__" "USE_BROADCAST" "" "$progress" "$total")
echo "bts=$temp"
let progress = progress + 1 

>&2 echo -e "\n%BTest Extra I"
echo -e "\n%BTest Extra I"
temp=$(conduct_test $tests "$procs" "$kappas" "__Question1__" "__QuestionExtra__" "USE_BROADCAST" "" "$progress" "$total")
echo "bte1=$temp"
let progress = progress + 1 
...
echo -e "\n%BTest Extra I Single proc"
temp=$(conduct_test $tests "1" "$kappas" "__Question1__" "__SingleProc__" "__QuestionExtra__" "USE_BROADCAST" "$progress" "$total")
echo "btes=$temp"
let progress = progress + 1 
...
>&2 echo -e "\n%AsBTest I"
echo -e "\n%AsBTest I"
temp=$(conduct_test $tests "$procs" "$kappas" "__Question1__" "USE_BROADCAST_ASYNC" "" "" "$progress" "$total")
echo "abt1=$temp"
let progress = progress + 1 

>&2 echo -e "\n%AsBTest II"
echo -e "\n%AsBTest II"
temp=$(conduct_test $tests "$procs" "$kappas" "__Question2__" "USE_BROADCAST_ASYNC" "" "" "$progress" "$total")
echo "abt2=$temp"
let progress = progress + 1 

>&2 echo -e "\n%AsBTest I Single proc"
echo -e "\n%AsBTest I Single proc"
temp=$(conduct_test $tests "1" "$kappas" "__Question1__" "__SingleProc__" "USE_BROADCAST_ASYNC" "" "$progress" "$total")
echo "abts=$temp"
let progress = progress + 1 

>&2 echo -e "\n%AsBTest Extra I"
echo -e "\n%AsBTest Extra I"
temp=$(conduct_test $tests "$procs" "$kappas" "__Question1__" "__QuestionExtra__" "USE_BROADCAST_ASYNC" "" "$progress" "$total")
echo "abte1=$temp"
let progress = progress + 1 
...
echo -e "\n%AsBTest Extra I Single proc"
temp=$(conduct_test $tests "1" "$kappas" "__Question1__" "__SingleProc__" "__QuestionExtra__" "USE_BROADCAST_ASYNC" "$progress" "$total")
echo "abtes=$temp"
let progress = progress + 1 